...
@section('title', 'Edit Topik - Ruang Budaya')
...
<div class="min-h-screen flex flex-col justify-center items-center py-12">
    ...
    <h1 class="text-4xl font-bold tracking-tight text-gray-900 mb-8">Edit Topik</h1>

    <form action="{{ route('forum.update', $thread->slug) }}" method="POST" enctype="multipart/form-data" class="w-full max-w-4xl bg-white p-10 rounded-lg shadow-sm">
        @csrf <!-- CSRF Token -->
        ...
        <div class="space-y-12">
            <div class="grid grid-cols-1 gap-x-8 gap-y-10 pb-12 md:grid-cols-3">
                <div>
                    ...
                    <p class="mt-1 text-sm leading-6 text-gray-600">Silakan isi informasi yang diperlukan untuk mengubah topik ini.</p>
                </div>
                ...
                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <input type="text" name="title" id="judul" value="{{ old('title', $thread->title) }}" class="block w-full rounded-md border-0 py-2 px-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Masukkan topik baru">
                            @error('title')
                    ...
                    <!-- Input Konten Topik dengan TinyMCE -->
                    <div class="col-span-full">
