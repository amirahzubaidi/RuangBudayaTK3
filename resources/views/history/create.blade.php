...
<div class="min-h-screen flex flex-col justify-center items-center py-12">
    ...
    <form action="{{ route('history.store') }}" method="POST" enctype="multipart/form-data" class="w-full max-w-4xl bg-white p-10 rounded-lg shadow-sm">
        @csrf
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-10 pb-12 md:grid-cols-3">
                ...
                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <input type="text" name="title" id="judul" value="{{ old('title') }}" class="block w-full rounded-md border-0 py-2 px-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Masukkan judul artikel">
                            @error('title')
